...
export const CONTENT_TYPES = [
    ...
    groups: [
      {
        legend: 'Name',
        fields: [
          { key: 'first', label: 'First name', type: 'text', autocomplete: 'given-name', placeholder: 'Alex', width: 'half' },
          { key: 'last', label: 'Last name', type: 'text', autocomplete: 'family-name', placeholder: 'Morgan', width: 'half' },
        ],
      },
      {
        legend: 'Work',
        fields: [
          { key: 'org', label: 'Organisation', type: 'text', autocomplete: 'organization', placeholder: 'Your company', width: 'full' },
          { key: 'title', label: 'Role', type: 'text', autocomplete: 'organization-title', placeholder: 'Your job title', width: 'full' },
        ],
      },
      {
        legend: 'Reach',
        fields: [
          { key: 'phone', label: 'Phone', type: 'tel', inputmode: 'tel', autocomplete: 'tel', placeholder: '+1 555 0100', width: 'full' },
          { key: 'email', label: 'Email', type: 'email', inputmode: 'email', autocomplete: 'email', placeholder: 'name@example.com', width: 'full' },
      ...
      },
      {
        ...
        collapsed: true,
        fields: [
          { key: 'street', label: 'Street', type: 'text', autocomplete: 'street-address', placeholder: '1 Main Street', width: 'full' },
          { key: 'city', label: 'City', type: 'text', autocomplete: 'address-level2', placeholder: 'Your city', width: 'half' },
          { key: 'postal', label: 'Postcode', type: 'text', inputmode: 'numeric', autocomplete: 'postal-code', placeholder: '00000', width: 'half' },
          { key: 'region', label: 'Region', type: 'text', autocomplete: 'address-level1', placeholder: 'State or region', width: 'half' },
          { key: 'country', label: 'Country', type: 'text', autocomplete: 'country-name', placeholder: 'Country', width: 'half' },
        ],
      },
      {
        legend: 'Social',
  ...
  },
  {
    ...
    groups: [{
      fields: [
        { key: 'to', label: 'To', type: 'email', inputmode: 'email', autocomplete: 'email', placeholder: 'name@example.com', width: 'full' },
  ...
  },
  {
    ...
    groups: [{
      fields: [
        ...
        { key: 'number', label: 'Number', type: 'tel', inputmode: 'tel', autocomplete: 'tel', placeholder: '+1 555 0100', width: 'full' },
        {
          key: 'message',
          label: 'Message',
          type: 'textarea',
  ...
  },
  {
    ...
    groups: [{
      fields: [
        { key: 'lat', label: 'Latitude', type: 'text', inputmode: 'decimal', placeholder: '51.5074', width: 'half' },
        { key: 'lon', label: 'Longitude', type: 'text', inputmode: 'decimal', placeholder: '-0.1278', width: 'half' },
      ],
    }],
  },
];
