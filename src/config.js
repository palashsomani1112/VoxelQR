...
import { cleanNote, NOTE_POSITIONS } from './export/note.js';
...
export function sanitize(config) {
  ...
  out.note = cleanNote(out.note);
  if (!NOTE_POSITIONS.includes(out.notePosition)) out.notePosition = DEFAULT_CONFIG.notePosition;
