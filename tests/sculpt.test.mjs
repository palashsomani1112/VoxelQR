...
const payloads = [
  'https://example.com',
  'https://palash.github.io/voxel-qr/',
...
const cases = {
  ...
  vcard: { first: 'Jane', last: 'Doe', org: 'Liberty, Mutual', phone: '+49 170 1234567', email: 'jane@example.com' },
  mecard: { first: 'Jane', last: 'Doe', phone: '+491701234567' },
  email: { to: 'a@b.com', subject: 'Hi there' },
  phone: { number: '+49 (170) 123-4567' },
  sms: { number: '+491701234567', message: 'yo' },
...
check('vcard escapes commas', buildPayload('vcard', cases.vcard).includes('ORG:Liberty\\, Mutual'));
...
check('phone strips punctuation', buildPayload('phone', cases.phone) === 'tel:+491701234567',
  buildPayload('phone', cases.phone));
check('geo formats numbers', buildPayload('geo', cases.geo) === 'geo:50.1109,8.6821');
